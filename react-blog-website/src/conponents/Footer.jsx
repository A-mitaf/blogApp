        ...
        <div className='grid mb-8 lg:grid-cols-6'>
            ...
            <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                    ...
                    <p className='mt-4 text-sm text-gray-500'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam, fugiat. Vitae magnam, necessitatibus earum ad eius ipsum modi voluptatem voluptas similique suscipit vel hic, molestias odio quam, in repudiandae harum?
                    </p>
                </div>
        </div>
